<template>
  <DocPageLayout
    title="DAO for King"
    description="dGuild governance uses a dual-DAO system that balances operational efficiency with participation"
  >
    <div class="content-section">
      <p class="lead">
        dGuild governance uses a dual-DAO system that balances operational efficiency with participation, 
        ensuring both contributors and stability providers have appropriate voice.
      </p>
    </div>
